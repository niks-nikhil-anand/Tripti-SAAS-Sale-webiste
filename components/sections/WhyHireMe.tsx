    ...
    <section className="rv max-w-[1240px] mx-auto px-4 sm:px-6 pt-16 sm:pt-24 lg:pt-28">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
        {whyHireMeReasons.map((r) => (
          ...
          >
            <p className="font-['Space_Grotesk'] font-bold text-[38px] sm:text-[48px] lg:text-[60px] leading-none mb-4 bg-[linear-gradient(140deg,#4d7cff,#8b5cf6)] [mask-image:linear-gradient(to_bottom,#000,#000)] bg-clip-text text-transparent">
              {r.n}
            </p>
            <h3 className="font-['Space_Grotesk'] font-bold text-[20px] mb-2.5 text-[var(--ink)]">
              {r.t}
            </h3>
